...
const state = {
  isShowAddMenu: false,
  addMenuContentLayerXY: { x: 0, y: 0 },
  currentBlockIndex: 0,
  currentPageBlocks: [
    { type: "heading1", data: { text: "All-in-one 是什么" } },
    {
      type: "text",
      data: {
    ...
    { type: "text", data: { text: "" } },
    { type: "todo", data: { isChecked: true, text: "纯文本" } },
    { type: "todo", data: { isChecked: true, text: "待办清单" } },
    { type: "todo", data: { isChecked: true, text: "标题1" } },
    { type: "todo", data: { isChecked: true, text: "标题2" } },
    { type: "todo", data: { isChecked: true, text: "标题3" } },
    { type: "todo", data: { isChecked: true, text: "符号列表" } },
    { type: "todo", data: { isChecked: true, text: "提示栏" } },
    { type: "todo", data: { isChecked: true, text: "组件的拖动排序" } },
    { type: "text", data: { text: "" } },
    { type: "hint", data: { text: "🧑‍💻待开发的功能清单" } },
    { type: "text", data: { text: "" } },
    { type: "todo", data: { isChecked: false, text: " 图片上传组件" } },
    { type: "todo", data: { isChecked: false, text: "事件节点组件" } },
    { type: "todo", data: { isChecked: false, text: "表格组件" } },
    { type: "todo", data: { isChecked: false, text: "看板组件" } },
    { type: "text", data: { text: "" } },
  ],
};
